    ...
    <div class="col-lg-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('outgoingroutes.update',[$outgoingRouting->id]) }}">
                    @csrf
                    @method('PATCH')
                    
                    <div class="form-group">
                        <label>Name:</label>
                        <input type="text" class="form-control  form-control-sm" name="rulename" value="{{ old('rulename',$outgoingRouting->rulename) }}">
                    </div>


                    <div class="form-group">
                        <label>Uwaga:</label>
                        <textarea rows="4" cols="5" class="form-control  form-control-sm" name="note" value="{{ old('note',$outgoingRouting->note) }}"></textarea>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <input type="text" class="form-control  form-control-sm" name="numberbeginswith" value="{{ old('numberbeginswith',$outgoingRouting->numberbeginswith) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control  form-control-sm" name="restnumbers" value="{{ old('restnumbers',$outgoingRouting->restnumbers) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-1">
                                    <input type="text" class="form-control  form-control-sm" name="trimfrombegin" value="{{ old('trimfrombegin',$outgoingRouting->trimfrombegin) }}"> 
                                </div>
                                <label class="col-lg-7 col-form-label"> cyfr na początku numeru, a następnie dodaj na początku</label>
                                <div class="col-lg-2">
                                    <input type="text" class="form-control  form-control-sm" name="prepend" value="{{ old('prepend',$outgoingRouting->prepend) }}">
                                </div>
                            </div>
                        </div>
                    </div>
