				...
				<div class="sidebar-section">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							<a href="{{ route('logout') }}" class="nav-link"><i class="icon-copy"></i> <span>Layouts1</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link">Default layout</a></li>
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link active">Layout 2</a></li>
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link">Layout 3</a></li>
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link">Layout 4</a></li>
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link">Layout 5</a></li>
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link">Layout 6</a></li>
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link disabled">Layout 7 <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
							</ul>
						</li>

						<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link"><i class="icon-width"></i> <span>RTL version</span></a></li>
						<!-- /main -->
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Page layouts">
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link">Static layout</a></li>
								<li class="nav-item"><a href="{{ route('logout') }}" class="nav-link">No header</a></li>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-lg-350">
								...
								<div class="dropdown-content-footer bg-light">
									...
									<div>
										...
										<a href="#" class="text-body ml-2" data-popup="tooltip" title="Settings"><i class="icon-cog3"></i></a>
									</div>
								</div>
							</div>
						</li>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-lg-350">
								<div class="dropdown-content-body p-2">
									<div class="row no-gutters">
										<div class="col-4">
											<a href="#" class="btn btn-outline-light border-transparent text-body btn-block py-2">
